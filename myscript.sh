...
echo "CREATE TABLE [IF NOT EXISTS] workers ('$col1' VARCHAR ( 50 ),'$col2' VARCHAR ( 50 ),'$col3' VARCHAR ( 50 ),'$col4' VARCHAR ( 50 ),'$col5' VARCHAR ( 50 ),'$col6' VARCHAR ( 50 ),'$col7' VARCHAR ( 50 ),'$col8' VARCHAR ( 50 ),'$col9' VARCHAR ( 50 ),'$col10' VARCHAR ( 50 ),'$col11' VARCHAR ( 50 ));" | psql $5;
title=true;
